...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            ...
            <div className="space-y-8">
              {/* Testimonial */}
              <div className="relative">
                <div className="absolute -top-4 -left-4 text-6xl text-[#093B]/20 font-serif">"</div>
                <blockquote className="bg-[#09303B]/5 rounded-xl p-6 border border-[#09303B]/10">
                  <p className="text-xl text-[#09303B] font-medium mb-4 leading-relaxed">
                    Profissionais altamente qualificados que transformaram uma situação complexa em uma solução eficaz para nossa empresa.
                  </p>
                  <footer className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-[#09303B]/10 rounded-full flex items-center justify-center">
                      <span className="text-[#09303B] font-bold">E</span>
                    </div>
                    <div>
                      <cite className="text-[#09303B] font-semibold not-italic">Empresa Cliente</cite>
                      <p className="text-[#09303B]/60 text-sm">Recuperação Judicial</p>
                    </div>
                  </footer>
                </blockquote>
              </div>
      ...
      {/* Áreas de Atuação */}
      <section className="py-16 relative overflow-hidden bg-[#FCFDFE]">
        {/* Background Elements */}
        <div className="absolute inset-0">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[#09303B]/80 max-w-3xl mx-auto">
      ...
      {/* Nossa Trajetória */}
      <section className="py-16 relative overflow-hidden bg-[#0b3a48] text-white">
        {/* Background Elements */}
        <div className="absolute inset-0">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center">
            <p className="text-xl text-white/80 max-w-3xl mx-auto mb-8">
              Nossa experiência e dedicação nos permitem oferecer soluções jurídicas eficazes e personalizadas para cada
              cliente.
            </p>
          </div>
        </div>
